...
def get_args():
	...
	parser.add_argument('--model', type=str, default='EF-Book')
	parser.add_argument('--mi_root', type=str, default='../../Dataset/EF-MI-MA/MI/')
	parser.add_argument('--mi_root', type=str, default='../../Dataset/EF-MI-MA/MA/')
	parser.add_argument('--wg_root', type=str, default='../../Dataset/EF-WG/WG/')

...
def log_metrics(subject, log_name, log_mode, acc_list, precision_list, recall_list, f1_list, kappa_list):
		...
		if log_mode in [0, 2]:
			log_path = f'Results/Subject_{subject}.txt'
		...
		if log_mode in [1, 2]:
			log_excel = 'Results/' + str(log_name) + '.xlsx'
